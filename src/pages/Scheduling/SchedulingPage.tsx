...
export const SchedulingPage = () => {
  ...
  useEffect(() => {
    if (date && selectedBarber) {
      ...
      if (workingHours.start && workingHours.end) {
        ...
        startTime.setHours(
          Number(workingHours.start.split(':')[0]),
          Number(workingHours.start.split(':')[1])
        )

        const endTime = new Date(date)
        endTime.setHours(
          Number(workingHours.end.split(':')[0]),
          Number(workingHours.end.split(':')[1])
        )

        const availableTimesForDay: string[] = []

        while (startTime < endTime) {
          availableTimesForDay.push(
  ...
  return (
    <>
      <div className="flex w-screen h-screen flex-column justify-content-start">
        ...
        <div>
          ...
          <div className="flex justify-content-center">
            <div className="flex flex-column pl-5">
              <div>
