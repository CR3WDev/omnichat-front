          ...
          <div className='w-12'>
            <div className='mb-2 w-12 h-3rem'>
              <Card className='mb-2 w-9 flex align-items-center h-3rem bg-gray-200'>
                <div className='w-12 flex align-items-center justify-content-start'>
                  <img className='w-3rem' src="https://static.ifood-static.com.br/image/upload/t_high/icones/payments/brands/ca34f400-9ba1-49c9-9f08-d269f97fd678" />
            ...
            <div className='mb-2 w-12 h-3rem'>
              <Card className='mb-2 w-6 flex align-items-center h-3rem bg-gray-200'>
                <div className='w-12 flex align-items-center justify-content-start'>
                  <img className='w-3rem' src="https://static.ifood-static.com.br/image/upload/t_high/icones/payments/brands/3fc410d4-a5ea-424c-8ef1-4847fc23723e" />
            ...
            <div className='mb-2 w-12 h-3rem'>
              <Card className='mb-2 w-6 flex align-items-center h-3rem bg-gray-200'>
                <div className='w-12 flex align-items-center justify-content-start'>
                  <img className='w-3rem' src="https://static.ifood-static.com.br/image/upload/t_high/icones/payments/brands/70764a4a-84bb-4697-82e2-7e63d88f4aa3" />
